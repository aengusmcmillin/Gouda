...
pub fn win32_process_keyboard(
    ...
    if was_down != is_down {
        if vkcode == VK_UP {
            ...
            win32_process_keyboard_message(&mut keyboard.special_keys[SpecialKeys::Enter], is_down);
        } else if vkcode == VK_SPACE {
            win32_process_keyboard_message(&mut keyboard.special_keys[SpecialKeys::Space], is_down);
        } else {
